...
const MiniCard = ({ mines }) => {
    return (
        <Link href={`/mines/${mines.Mine_ID}`}>
            <div className="p-3 rounded-xl flex flex-col w-100 h-100 border border-gray-300 transition-transform transform hover:scale-105 hover:shadow-2xl hover:translate-y-2 duration-300">
                ...
                <div className="flex gap-4">
                    ...
                    <div className=" rounded-xl  overflow-clip">
                        <Image src={mine1} width={100} height={100} alt="mine1" />
                    </div>
